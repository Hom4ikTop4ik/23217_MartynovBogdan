...
{
    printf("Instruction:\n");
    printf("1. If you use Windows, run without arguments to start program with GUI.\n");
    printf("2. If you use Linux, run program without arguments to get this instruction: \n");
    printf("   If you want encode/compress file(s) run program with args: compress [archive name] [1+ files].\n");
    printf("   If you want decode/decompress file(s) run program with args: decompress [1+ archives].\n");
}
